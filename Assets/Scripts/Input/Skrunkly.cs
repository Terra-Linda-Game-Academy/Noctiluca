...
//     version 1.4.3
//     from Assets/Scripts/Input/Skrunkly.inputactions
//
...
namespace Input
{
    public partial class @Skrunkly : IInputActionCollection2, IDisposable
    {
    ...
    ""controlSchemes"": [
        ...
        {
            private @Skrunkly m_Wrapper;
            public InGameActions(@Skrunkly wrapper) { m_Wrapper = wrapper; }
        ...
        {
            private @Skrunkly m_Wrapper;
            public MenuActions(@Skrunkly wrapper) { m_Wrapper = wrapper; }
