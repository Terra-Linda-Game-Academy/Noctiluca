...
namespace Input.ConcreteInputProviders.Enemy
{
    ...
    public class WalkingEnemyInputProvider : InputProvider<WalkingEnemyInput, WalkingEnemyInputEvents, WalkingEnemyInputEvents.Dispatcher, WalkingEnemyInputProvider> { }
}